...
export class Backend implements backendInterface {
    ...
    async getAllSurahs(): Promise<Array<Surah>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllSurahs();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getAyahsForSurah(arg0: bigint): Promise<Array<Ayah>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAyahsForSurah(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
